#ifndef _MROS_MSG_std_msgs_UInt64Array_h
#define _MROS_MSG_std_msgs_UInt64Array_h
...
namespace std_msgs
{
  ...
  class UInt64Array : public mros::Msg
  {
    public:
    ...
    void parse(Msg* __msg__, const std::string& __json__)
    {
      try {
        ...
        ((UInt64Array*)__msg__)->header.parse(&((UInt64Array*)__msg__)->header, __stream_header__.str());
        mros::json::Array __array_data__ = mros::json::Array(__root__["data"]);
        ((UInt64Array*)__msg__)->data.resize(__array_data__.Size()); 
        for( uint32_t i = 0; i < __array_data__.Size(); i++) {
          ((UInt64Array*)__msg__)->data[i] = mros::json::Number(__root__["data"][i]).Value();
        }
    ...
    virtual const std::string getType() const { return "std_msgs/UInt64Array"; }
    static std::string getTypeStatic(){ return "std_msgs/UInt64Array"; }
    virtual const std::string getMD5() const { return "bd61527ec56810991d9513df3b4e1a1a"; }
    static std::string getMD5Static(){ return "bd61527ec56810991d9513df3b4e1a1a"; }
    ...
    typedef std::shared_ptr<mros::std_msgs::UInt64Array> Ptr;
    typedef std::shared_ptr<mros::std_msgs::UInt64Array const> ConstPtr;
  };
typedef std::shared_ptr<mros::std_msgs::UInt64Array> UInt64ArrayPtr;
typedef std::shared_ptr<mros::std_msgs::UInt64Array const> UInt64ArrayConstPtr;
