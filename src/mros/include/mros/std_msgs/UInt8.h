#ifndef _MROS_MSG_std_msgs_UInt8_h
#define _MROS_MSG_std_msgs_UInt8_h
  ...
  class UInt8 : public mros::Msg
  {
    ...
    void parse(Msg* __msg__, const std::string& __json__)
    {
      try {
        ...
        ((UInt8*)__msg__)->data = mros::json::Number(__root__["data"]).Value();
    ...
    virtual const std::string getType() const { return "std_msgs/UInt8"; }
    static std::string getTypeStatic(){ return "std_msgs/UInt8"; }
    virtual const std::string getMD5() const { return "7c8164229e7d2c17eb95e9231617fdee"; }
    static std::string getMD5Static(){ return "7c8164229e7d2c17eb95e9231617fdee"; }
    virtual const std::string getDefinition() const { return "uint8 data\n"; }
    static std::string getDefinitionStatic(){ return "uint8 data\n"; }
    static bool hasHeader(){ return false; }
    typedef std::shared_ptr<mros::std_msgs::UInt8> Ptr;
    typedef std::shared_ptr<mros::std_msgs::UInt8 const> ConstPtr;
  };
typedef std::shared_ptr<mros::std_msgs::UInt8> UInt8Ptr;
typedef std::shared_ptr<mros::std_msgs::UInt8 const> UInt8ConstPtr;
