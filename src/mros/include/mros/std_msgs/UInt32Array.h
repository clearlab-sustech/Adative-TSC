#ifndef _MROS_MSG_std_msgs_UInt32Array_h
#define _MROS_MSG_std_msgs_UInt32Array_h
...
namespace std_msgs
{
  ...
  class UInt32Array : public mros::Msg
  {
    public:
    ...
    void parse(Msg* __msg__, const std::string& __json__)
    {
      try {
        ...
        ((UInt32Array*)__msg__)->header.parse(&((UInt32Array*)__msg__)->header, __stream_header__.str());
        mros::json::Array __array_data__ = mros::json::Array(__root__["data"]);
        ((UInt32Array*)__msg__)->data.resize(__array_data__.Size()); 
        for( uint32_t i = 0; i < __array_data__.Size(); i++) {
          ((UInt32Array*)__msg__)->data[i] = mros::json::Number(__root__["data"][i]).Value();
        }
    ...
    virtual const std::string getType() const { return "std_msgs/UInt32Array"; }
    static std::string getTypeStatic(){ return "std_msgs/UInt32Array"; }
    virtual const std::string getMD5() const { return "1157fa569ae93e44dd2b839ca131f39e"; }
    static std::string getMD5Static(){ return "1157fa569ae93e44dd2b839ca131f39e"; }
    ...
    typedef std::shared_ptr<mros::std_msgs::UInt32Array> Ptr;
    typedef std::shared_ptr<mros::std_msgs::UInt32Array const> ConstPtr;
  };
typedef std::shared_ptr<mros::std_msgs::UInt32Array> UInt32ArrayPtr;
typedef std::shared_ptr<mros::std_msgs::UInt32Array const> UInt32ArrayConstPtr;
