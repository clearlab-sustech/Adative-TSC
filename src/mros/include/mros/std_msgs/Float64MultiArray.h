#ifndef _MROS_MSG_std_msgs_Float64MultiArray_h
#define _MROS_MSG_std_msgs_Float64MultiArray_h
...
namespace std_msgs
{
  ...
  class Float64MultiArray : public mros::Msg
  {
    public:
    ...
    void parse(Msg* __msg__, const std::string& __json__)
    {
      try {
        ...
        ((Float64MultiArray*)__msg__)->layout.parse(&((Float64MultiArray*)__msg__)->layout, __stream_layout__.str());
        mros::json::Array __array_data__ = mros::json::Array(__root__["data"]);
        ((Float64MultiArray*)__msg__)->data.resize(__array_data__.Size()); 
        for( uint32_t i = 0; i < __array_data__.Size(); i++) {
          ((Float64MultiArray*)__msg__)->data[i] = mros::json::Number(__root__["data"][i]).Value();
        }
    ...
    virtual const std::string getType() const { return "std_msgs/Float64MultiArray"; }
    static std::string getTypeStatic(){ return "std_msgs/Float64MultiArray"; }
    virtual const std::string getMD5() const { return "4b7d974086d4060e7db4613a7e6c3ba4"; }
    static std::string getMD5Static(){ return "4b7d974086d4060e7db4613a7e6c3ba4"; }
    ...
    typedef std::shared_ptr<mros::std_msgs::Float64MultiArray> Ptr;
    typedef std::shared_ptr<mros::std_msgs::Float64MultiArray const> ConstPtr;
  };
typedef std::shared_ptr<mros::std_msgs::Float64MultiArray> Float64MultiArrayPtr;
typedef std::shared_ptr<mros::std_msgs::Float64MultiArray const> Float64MultiArrayConstPtr;
