#ifndef _MROS_MSG_std_msgs_UInt8Array_h
#define _MROS_MSG_std_msgs_UInt8Array_h
...
namespace std_msgs
{
  ...
  class UInt8Array : public mros::Msg
  {
    public:
    ...
    void parse(Msg* __msg__, const std::string& __json__)
    {
      try {
        ...
        ((UInt8Array*)__msg__)->header.parse(&((UInt8Array*)__msg__)->header, __stream_header__.str());
        mros::json::Array __array_data__ = mros::json::Array(__root__["data"]);
        ((UInt8Array*)__msg__)->data.resize(__array_data__.Size()); 
        for( uint32_t i = 0; i < __array_data__.Size(); i++) {
          ((UInt8Array*)__msg__)->data[i] = mros::json::Number(__root__["data"][i]).Value();
        }
    ...
    virtual const std::string getType() const { return "std_msgs/UInt8Array"; }
    static std::string getTypeStatic(){ return "std_msgs/UInt8Array"; }
    virtual const std::string getMD5() const { return "8903b686ebe5db3477e83c6d0bb149f8"; }
    static std::string getMD5Static(){ return "8903b686ebe5db3477e83c6d0bb149f8"; }
    ...
    typedef std::shared_ptr<mros::std_msgs::UInt8Array> Ptr;
    typedef std::shared_ptr<mros::std_msgs::UInt8Array const> ConstPtr;
  };
typedef std::shared_ptr<mros::std_msgs::UInt8Array> UInt8ArrayPtr;
typedef std::shared_ptr<mros::std_msgs::UInt8Array const> UInt8ArrayConstPtr;
