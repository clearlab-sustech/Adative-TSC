#ifndef _MROS_MSG_std_msgs_Float64Array_h
#define _MROS_MSG_std_msgs_Float64Array_h
...
namespace std_msgs
{
  ...
  class Float64Array : public mros::Msg
  {
    public:
    ...
    void parse(Msg* __msg__, const std::string& __json__)
    {
      try {
        ...
        ((Float64Array*)__msg__)->header.parse(&((Float64Array*)__msg__)->header, __stream_header__.str());
        mros::json::Array __array_data__ = mros::json::Array(__root__["data"]);
        ((Float64Array*)__msg__)->data.resize(__array_data__.Size()); 
        for( uint32_t i = 0; i < __array_data__.Size(); i++) {
          ((Float64Array*)__msg__)->data[i] = mros::json::Number(__root__["data"][i]).Value();
        }
    ...
    virtual const std::string getType() const { return "std_msgs/Float64Array"; }
    static std::string getTypeStatic(){ return "std_msgs/Float64Array"; }
    virtual const std::string getMD5() const { return "fb60495edd59d3fcf90e173153ae8a9a"; }
    static std::string getMD5Static(){ return "fb60495edd59d3fcf90e173153ae8a9a"; }
    ...
    typedef std::shared_ptr<mros::std_msgs::Float64Array> Ptr;
    typedef std::shared_ptr<mros::std_msgs::Float64Array const> ConstPtr;
  };
typedef std::shared_ptr<mros::std_msgs::Float64Array> Float64ArrayPtr;
typedef std::shared_ptr<mros::std_msgs::Float64Array const> Float64ArrayConstPtr;
