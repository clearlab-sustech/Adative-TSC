#ifndef _MROS_MSG_std_msgs_UInt8MultiArray_h
#define _MROS_MSG_std_msgs_UInt8MultiArray_h
...
namespace std_msgs
{
  ...
  class UInt8MultiArray : public mros::Msg
  {
    public:
    ...
    void parse(Msg* __msg__, const std::string& __json__)
    {
      try {
        ...
        ((UInt8MultiArray*)__msg__)->layout.parse(&((UInt8MultiArray*)__msg__)->layout, __stream_layout__.str());
        mros::json::Array __array_data__ = mros::json::Array(__root__["data"]);
        ((UInt8MultiArray*)__msg__)->data.resize(__array_data__.Size()); 
        for( uint32_t i = 0; i < __array_data__.Size(); i++) {
          ((UInt8MultiArray*)__msg__)->data[i] = mros::json::Number(__root__["data"][i]).Value();
        }
    ...
    virtual const std::string getType() const { return "std_msgs/UInt8MultiArray"; }
    static std::string getTypeStatic(){ return "std_msgs/UInt8MultiArray"; }
    virtual const std::string getMD5() const { return "82373f1612381bb6ee473b5cd6f5d89c"; }
    static std::string getMD5Static(){ return "82373f1612381bb6ee473b5cd6f5d89c"; }
    ...
    typedef std::shared_ptr<mros::std_msgs::UInt8MultiArray> Ptr;
    typedef std::shared_ptr<mros::std_msgs::UInt8MultiArray const> ConstPtr;
  };
typedef std::shared_ptr<mros::std_msgs::UInt8MultiArray> UInt8MultiArrayPtr;
typedef std::shared_ptr<mros::std_msgs::UInt8MultiArray const> UInt8MultiArrayConstPtr;
