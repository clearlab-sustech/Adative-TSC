#ifndef _MROS_MSG_std_msgs_UInt64MultiArray_h
#define _MROS_MSG_std_msgs_UInt64MultiArray_h
...
namespace std_msgs
{
  ...
  class UInt64MultiArray : public mros::Msg
  {
    public:
    ...
    void parse(Msg* __msg__, const std::string& __json__)
    {
      try {
        ...
        ((UInt64MultiArray*)__msg__)->layout.parse(&((UInt64MultiArray*)__msg__)->layout, __stream_layout__.str());
        mros::json::Array __array_data__ = mros::json::Array(__root__["data"]);
        ((UInt64MultiArray*)__msg__)->data.resize(__array_data__.Size()); 
        for( uint32_t i = 0; i < __array_data__.Size(); i++) {
          ((UInt64MultiArray*)__msg__)->data[i] = mros::json::Number(__root__["data"][i]).Value();
        }
    ...
    virtual const std::string getType() const { return "std_msgs/UInt64MultiArray"; }
    static std::string getTypeStatic(){ return "std_msgs/UInt64MultiArray"; }
    virtual const std::string getMD5() const { return "6088f127afb1d6c72927aa1247e945af"; }
    static std::string getMD5Static(){ return "6088f127afb1d6c72927aa1247e945af"; }
    ...
    typedef std::shared_ptr<mros::std_msgs::UInt64MultiArray> Ptr;
    typedef std::shared_ptr<mros::std_msgs::UInt64MultiArray const> ConstPtr;
  };
typedef std::shared_ptr<mros::std_msgs::UInt64MultiArray> UInt64MultiArrayPtr;
typedef std::shared_ptr<mros::std_msgs::UInt64MultiArray const> UInt64MultiArrayConstPtr;
