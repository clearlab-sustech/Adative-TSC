#ifndef _MROS_MSG_std_msgs_Int32Array_h
#define _MROS_MSG_std_msgs_Int32Array_h
...
namespace std_msgs
{
  ...
  class Int32Array : public mros::Msg
  {
    public:
    ...
    void parse(Msg* __msg__, const std::string& __json__)
    {
      try {
        ...
        ((Int32Array*)__msg__)->header.parse(&((Int32Array*)__msg__)->header, __stream_header__.str());
        mros::json::Array __array_data__ = mros::json::Array(__root__["data"]);
        ((Int32Array*)__msg__)->data.resize(__array_data__.Size()); 
        for( uint32_t i = 0; i < __array_data__.Size(); i++) {
          ((Int32Array*)__msg__)->data[i] = mros::json::Number(__root__["data"][i]).Value();
        }
    ...
    virtual const std::string getType() const { return "std_msgs/Int32Array"; }
    static std::string getTypeStatic(){ return "std_msgs/Int32Array"; }
    virtual const std::string getMD5() const { return "1ce4762ce13f3d9e1f17586acc253067"; }
    static std::string getMD5Static(){ return "1ce4762ce13f3d9e1f17586acc253067"; }
    ...
    typedef std::shared_ptr<mros::std_msgs::Int32Array> Ptr;
    typedef std::shared_ptr<mros::std_msgs::Int32Array const> ConstPtr;
  };
typedef std::shared_ptr<mros::std_msgs::Int32Array> Int32ArrayPtr;
typedef std::shared_ptr<mros::std_msgs::Int32Array const> Int32ArrayConstPtr;
