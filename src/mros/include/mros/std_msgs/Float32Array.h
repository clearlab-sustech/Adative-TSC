#ifndef _MROS_MSG_std_msgs_Float32Array_h
#define _MROS_MSG_std_msgs_Float32Array_h
...
namespace std_msgs
{
  ...
  class Float32Array : public mros::Msg
  {
    public:
    ...
    void parse(Msg* __msg__, const std::string& __json__)
    {
      try {
        ...
        ((Float32Array*)__msg__)->header.parse(&((Float32Array*)__msg__)->header, __stream_header__.str());
        mros::json::Array __array_data__ = mros::json::Array(__root__["data"]);
        ((Float32Array*)__msg__)->data.resize(__array_data__.Size()); 
        for( uint32_t i = 0; i < __array_data__.Size(); i++) {
          ((Float32Array*)__msg__)->data[i] = mros::json::Number(__root__["data"][i]).Value();
        }
    ...
    virtual const std::string getType() const { return "std_msgs/Float32Array"; }
    static std::string getTypeStatic(){ return "std_msgs/Float32Array"; }
    virtual const std::string getMD5() const { return "a120344537a3b099cc9ec9957d4619fc"; }
    static std::string getMD5Static(){ return "a120344537a3b099cc9ec9957d4619fc"; }
    ...
    typedef std::shared_ptr<mros::std_msgs::Float32Array> Ptr;
    typedef std::shared_ptr<mros::std_msgs::Float32Array const> ConstPtr;
  };
typedef std::shared_ptr<mros::std_msgs::Float32Array> Float32ArrayPtr;
typedef std::shared_ptr<mros::std_msgs::Float32Array const> Float32ArrayConstPtr;
