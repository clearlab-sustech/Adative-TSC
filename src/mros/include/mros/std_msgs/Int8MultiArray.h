#ifndef _MROS_MSG_std_msgs_Int8MultiArray_h
#define _MROS_MSG_std_msgs_Int8MultiArray_h
...
namespace std_msgs
{
  ...
  class Int8MultiArray : public mros::Msg
  {
    public:
    ...
    void parse(Msg* __msg__, const std::string& __json__)
    {
      try {
        ...
        ((Int8MultiArray*)__msg__)->layout.parse(&((Int8MultiArray*)__msg__)->layout, __stream_layout__.str());
        mros::json::Array __array_data__ = mros::json::Array(__root__["data"]);
        ((Int8MultiArray*)__msg__)->data.resize(__array_data__.Size()); 
        for( uint32_t i = 0; i < __array_data__.Size(); i++) {
          ((Int8MultiArray*)__msg__)->data[i] = mros::json::Number(__root__["data"][i]).Value();
        }
    ...
    virtual const std::string getType() const { return "std_msgs/Int8MultiArray"; }
    static std::string getTypeStatic(){ return "std_msgs/Int8MultiArray"; }
    virtual const std::string getMD5() const { return "d7c1af35a1b4781bbe79e03dd94b7c13"; }
    static std::string getMD5Static(){ return "d7c1af35a1b4781bbe79e03dd94b7c13"; }
    ...
    typedef std::shared_ptr<mros::std_msgs::Int8MultiArray> Ptr;
    typedef std::shared_ptr<mros::std_msgs::Int8MultiArray const> ConstPtr;
  };
typedef std::shared_ptr<mros::std_msgs::Int8MultiArray> Int8MultiArrayPtr;
typedef std::shared_ptr<mros::std_msgs::Int8MultiArray const> Int8MultiArrayConstPtr;
