#ifndef _MROS_MSG_std_msgs_Int16MultiArray_h
#define _MROS_MSG_std_msgs_Int16MultiArray_h
...
namespace std_msgs
{
  ...
  class Int16MultiArray : public mros::Msg
  {
    public:
    ...
    void parse(Msg* __msg__, const std::string& __json__)
    {
      try {
        ...
        ((Int16MultiArray*)__msg__)->layout.parse(&((Int16MultiArray*)__msg__)->layout, __stream_layout__.str());
        mros::json::Array __array_data__ = mros::json::Array(__root__["data"]);
        ((Int16MultiArray*)__msg__)->data.resize(__array_data__.Size()); 
        for( uint32_t i = 0; i < __array_data__.Size(); i++) {
          ((Int16MultiArray*)__msg__)->data[i] = mros::json::Number(__root__["data"][i]).Value();
        }
    ...
    virtual const std::string getType() const { return "std_msgs/Int16MultiArray"; }
    static std::string getTypeStatic(){ return "std_msgs/Int16MultiArray"; }
    virtual const std::string getMD5() const { return "d9338d7f523fcb692fae9d0a0e9f067c"; }
    static std::string getMD5Static(){ return "d9338d7f523fcb692fae9d0a0e9f067c"; }
    ...
    typedef std::shared_ptr<mros::std_msgs::Int16MultiArray> Ptr;
    typedef std::shared_ptr<mros::std_msgs::Int16MultiArray const> ConstPtr;
  };
typedef std::shared_ptr<mros::std_msgs::Int16MultiArray> Int16MultiArrayPtr;
typedef std::shared_ptr<mros::std_msgs::Int16MultiArray const> Int16MultiArrayConstPtr;
