#ifndef _MROS_MSG_std_msgs_UInt16MultiArray_h
#define _MROS_MSG_std_msgs_UInt16MultiArray_h
...
namespace std_msgs
{
  ...
  class UInt16MultiArray : public mros::Msg
  {
    public:
    ...
    virtual int serialize(unsigned char *__outbuffer__, int __count__) const
    {
      ...
      __offset__ += 4;
      memcpy(__outbuffer__ + __offset__, this->data.data(), __data_length__ * 2);
      __offset__ += __data_length__ * 2;
      return __offset__;
    }
    ...
    virtual int deserialize(unsigned char *__inbuffer__, int __count__)
    {
      ...
      __offset__ += 4;
      memcpy(this->data.data(), __inbuffer__ + __offset__, __data_length__ * 2);
      __offset__ += __data_length__ * 2;
      return __offset__;
    }
    ...
    void parse(Msg* __msg__, const std::string& __json__)
    {
      try {
        ...
        ((UInt16MultiArray*)__msg__)->layout.parse(&((UInt16MultiArray*)__msg__)->layout, __stream_layout__.str());
        mros::json::Array __array_data__ = mros::json::Array(__root__["data"]);
        ((UInt16MultiArray*)__msg__)->data.resize(__array_data__.Size()); 
        for( uint32_t i = 0; i < __array_data__.Size(); i++) {
          ((UInt16MultiArray*)__msg__)->data[i] = mros::json::Number(__root__["data"][i]).Value();
        }
    ...
    virtual const std::string getType() const { return "std_msgs/UInt16MultiArray"; }
    static std::string getTypeStatic(){ return "std_msgs/UInt16MultiArray"; }
    virtual const std::string getMD5() const { return "52f264f1c973c4b73790d384c6cb4484"; }
    static std::string getMD5Static(){ return "52f264f1c973c4b73790d384c6cb4484"; }
    ...
    typedef std::shared_ptr<mros::std_msgs::UInt16MultiArray> Ptr;
    typedef std::shared_ptr<mros::std_msgs::UInt16MultiArray const> ConstPtr;
  };
typedef std::shared_ptr<mros::std_msgs::UInt16MultiArray> UInt16MultiArrayPtr;
typedef std::shared_ptr<mros::std_msgs::UInt16MultiArray const> UInt16MultiArrayConstPtr;
