#ifndef _MROS_MSG_std_msgs_UInt16Array_h
#define _MROS_MSG_std_msgs_UInt16Array_h
...
namespace std_msgs
{
  ...
  class UInt16Array : public mros::Msg
  {
    public:
    ...
    void parse(Msg* __msg__, const std::string& __json__)
    {
      try {
        ...
        ((UInt16Array*)__msg__)->header.parse(&((UInt16Array*)__msg__)->header, __stream_header__.str());
        mros::json::Array __array_data__ = mros::json::Array(__root__["data"]);
        ((UInt16Array*)__msg__)->data.resize(__array_data__.Size()); 
        for( uint32_t i = 0; i < __array_data__.Size(); i++) {
          ((UInt16Array*)__msg__)->data[i] = mros::json::Number(__root__["data"][i]).Value();
        }
    ...
    virtual const std::string getType() const { return "std_msgs/UInt16Array"; }
    static std::string getTypeStatic(){ return "std_msgs/UInt16Array"; }
    virtual const std::string getMD5() const { return "2b9446334eb40dbaedf25a747be49905"; }
    static std::string getMD5Static(){ return "2b9446334eb40dbaedf25a747be49905"; }
    ...
    typedef std::shared_ptr<mros::std_msgs::UInt16Array> Ptr;
    typedef std::shared_ptr<mros::std_msgs::UInt16Array const> ConstPtr;
  };
typedef std::shared_ptr<mros::std_msgs::UInt16Array> UInt16ArrayPtr;
typedef std::shared_ptr<mros::std_msgs::UInt16Array const> UInt16ArrayConstPtr;
