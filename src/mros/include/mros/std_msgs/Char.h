#ifndef _MROS_MSG_std_msgs_Char_h
#define _MROS_MSG_std_msgs_Char_h
  ...
  class Char : public mros::Msg
  {
    ...
    void parse(Msg* __msg__, const std::string& __json__)
    {
      try {
        ...
        ((Char*)__msg__)->data = mros::json::Number(__root__["data"]).Value();
    ...
    virtual const std::string getType() const { return "std_msgs/Char"; }
    static std::string getTypeStatic(){ return "std_msgs/Char"; }
    virtual const std::string getMD5() const { return "1bf77f25acecdedba0e224b162199717"; }
    static std::string getMD5Static(){ return "1bf77f25acecdedba0e224b162199717"; }
    virtual const std::string getDefinition() const { return "char data\n"; }
    static std::string getDefinitionStatic(){ return "char data\n"; }
    static bool hasHeader(){ return false; }
    typedef std::shared_ptr<mros::std_msgs::Char> Ptr;
    typedef std::shared_ptr<mros::std_msgs::Char const> ConstPtr;
  };
typedef std::shared_ptr<mros::std_msgs::Char> CharPtr;
typedef std::shared_ptr<mros::std_msgs::Char const> CharConstPtr;
