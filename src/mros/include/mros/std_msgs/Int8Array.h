#ifndef _MROS_MSG_std_msgs_Int8Array_h
#define _MROS_MSG_std_msgs_Int8Array_h
...
namespace std_msgs
{
  ...
  class Int8Array : public mros::Msg
  {
    public:
    ...
    void parse(Msg* __msg__, const std::string& __json__)
    {
      try {
        ...
        ((Int8Array*)__msg__)->header.parse(&((Int8Array*)__msg__)->header, __stream_header__.str());
        mros::json::Array __array_data__ = mros::json::Array(__root__["data"]);
        ((Int8Array*)__msg__)->data.resize(__array_data__.Size()); 
        for( uint32_t i = 0; i < __array_data__.Size(); i++) {
          ((Int8Array*)__msg__)->data[i] = mros::json::Number(__root__["data"][i]).Value();
        }
    ...
    virtual const std::string getType() const { return "std_msgs/Int8Array"; }
    static std::string getTypeStatic(){ return "std_msgs/Int8Array"; }
    virtual const std::string getMD5() const { return "76e8caca558be0db7a08d3479289f362"; }
    static std::string getMD5Static(){ return "76e8caca558be0db7a08d3479289f362"; }
    ...
    typedef std::shared_ptr<mros::std_msgs::Int8Array> Ptr;
    typedef std::shared_ptr<mros::std_msgs::Int8Array const> ConstPtr;
  };
typedef std::shared_ptr<mros::std_msgs::Int8Array> Int8ArrayPtr;
typedef std::shared_ptr<mros::std_msgs::Int8Array const> Int8ArrayConstPtr;
