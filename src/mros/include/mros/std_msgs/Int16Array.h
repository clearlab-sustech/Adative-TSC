#ifndef _MROS_MSG_std_msgs_Int16Array_h
#define _MROS_MSG_std_msgs_Int16Array_h
...
namespace std_msgs
{
  ...
  class Int16Array : public mros::Msg
  {
    public:
    ...
    void parse(Msg* __msg__, const std::string& __json__)
    {
      try {
        ...
        ((Int16Array*)__msg__)->header.parse(&((Int16Array*)__msg__)->header, __stream_header__.str());
        mros::json::Array __array_data__ = mros::json::Array(__root__["data"]);
        ((Int16Array*)__msg__)->data.resize(__array_data__.Size()); 
        for( uint32_t i = 0; i < __array_data__.Size(); i++) {
          ((Int16Array*)__msg__)->data[i] = mros::json::Number(__root__["data"][i]).Value();
        }
    ...
    virtual const std::string getType() const { return "std_msgs/Int16Array"; }
    static std::string getTypeStatic(){ return "std_msgs/Int16Array"; }
    virtual const std::string getMD5() const { return "dc47eb145a11cbe02d6c8cb8248a4099"; }
    static std::string getMD5Static(){ return "dc47eb145a11cbe02d6c8cb8248a4099"; }
    ...
    typedef std::shared_ptr<mros::std_msgs::Int16Array> Ptr;
    typedef std::shared_ptr<mros::std_msgs::Int16Array const> ConstPtr;
  };
typedef std::shared_ptr<mros::std_msgs::Int16Array> Int16ArrayPtr;
typedef std::shared_ptr<mros::std_msgs::Int16Array const> Int16ArrayConstPtr;
