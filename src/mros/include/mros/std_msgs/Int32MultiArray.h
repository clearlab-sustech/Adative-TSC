#ifndef _MROS_MSG_std_msgs_Int32MultiArray_h
#define _MROS_MSG_std_msgs_Int32MultiArray_h
...
namespace std_msgs
{
  ...
  class Int32MultiArray : public mros::Msg
  {
    public:
    ...
    void parse(Msg* __msg__, const std::string& __json__)
    {
      try {
        ...
        ((Int32MultiArray*)__msg__)->layout.parse(&((Int32MultiArray*)__msg__)->layout, __stream_layout__.str());
        mros::json::Array __array_data__ = mros::json::Array(__root__["data"]);
        ((Int32MultiArray*)__msg__)->data.resize(__array_data__.Size()); 
        for( uint32_t i = 0; i < __array_data__.Size(); i++) {
          ((Int32MultiArray*)__msg__)->data[i] = mros::json::Number(__root__["data"][i]).Value();
        }
    ...
    virtual const std::string getType() const { return "std_msgs/Int32MultiArray"; }
    static std::string getTypeStatic(){ return "std_msgs/Int32MultiArray"; }
    virtual const std::string getMD5() const { return "1d99f79f8b325b44fee908053e9c945b"; }
    static std::string getMD5Static(){ return "1d99f79f8b325b44fee908053e9c945b"; }
    ...
    typedef std::shared_ptr<mros::std_msgs::Int32MultiArray> Ptr;
    typedef std::shared_ptr<mros::std_msgs::Int32MultiArray const> ConstPtr;
  };
typedef std::shared_ptr<mros::std_msgs::Int32MultiArray> Int32MultiArrayPtr;
typedef std::shared_ptr<mros::std_msgs::Int32MultiArray const> Int32MultiArrayConstPtr;
