#ifndef _MROS_MSG_std_msgs_Int64MultiArray_h
#define _MROS_MSG_std_msgs_Int64MultiArray_h
...
namespace std_msgs
{
  ...
  class Int64MultiArray : public mros::Msg
  {
    public:
    ...
    void parse(Msg* __msg__, const std::string& __json__)
    {
      try {
        ...
        ((Int64MultiArray*)__msg__)->layout.parse(&((Int64MultiArray*)__msg__)->layout, __stream_layout__.str());
        mros::json::Array __array_data__ = mros::json::Array(__root__["data"]);
        ((Int64MultiArray*)__msg__)->data.resize(__array_data__.Size()); 
        for( uint32_t i = 0; i < __array_data__.Size(); i++) {
          ((Int64MultiArray*)__msg__)->data[i] = mros::json::Number(__root__["data"][i]).Value();
        }
    ...
    virtual const std::string getType() const { return "std_msgs/Int64MultiArray"; }
    static std::string getTypeStatic(){ return "std_msgs/Int64MultiArray"; }
    virtual const std::string getMD5() const { return "54865aa6c65be0448113a2afc6a49270"; }
    static std::string getMD5Static(){ return "54865aa6c65be0448113a2afc6a49270"; }
    ...
    typedef std::shared_ptr<mros::std_msgs::Int64MultiArray> Ptr;
    typedef std::shared_ptr<mros::std_msgs::Int64MultiArray const> ConstPtr;
  };
typedef std::shared_ptr<mros::std_msgs::Int64MultiArray> Int64MultiArrayPtr;
typedef std::shared_ptr<mros::std_msgs::Int64MultiArray const> Int64MultiArrayConstPtr;
