#ifndef _MROS_MSG_std_msgs_ByteArray_h
#define _MROS_MSG_std_msgs_ByteArray_h
...
namespace std_msgs
{
  ...
  class ByteArray : public mros::Msg
  {
    public:
    ...
    void parse(Msg* __msg__, const std::string& __json__)
    {
      try {
        ...
        ((ByteArray*)__msg__)->header.parse(&((ByteArray*)__msg__)->header, __stream_header__.str());
        mros::json::Array __array_data__ = mros::json::Array(__root__["data"]);
        ((ByteArray*)__msg__)->data.resize(__array_data__.Size()); 
        for( uint32_t i = 0; i < __array_data__.Size(); i++) {
          ((ByteArray*)__msg__)->data[i] = mros::json::Number(__root__["data"][i]).Value();
        }
    ...
    virtual const std::string getType() const { return "std_msgs/ByteArray"; }
    static std::string getTypeStatic(){ return "std_msgs/ByteArray"; }
    virtual const std::string getMD5() const { return "1a80b57fc88eea2f0cd76ef6a9312f0b"; }
    static std::string getMD5Static(){ return "1a80b57fc88eea2f0cd76ef6a9312f0b"; }
    ...
    typedef std::shared_ptr<mros::std_msgs::ByteArray> Ptr;
    typedef std::shared_ptr<mros::std_msgs::ByteArray const> ConstPtr;
  };
typedef std::shared_ptr<mros::std_msgs::ByteArray> ByteArrayPtr;
typedef std::shared_ptr<mros::std_msgs::ByteArray const> ByteArrayConstPtr;
