...
namespace clear
{
  ...
  public:
    TrajectoryStabilizer(Node::SharedPtr nodeHandle, const std::string config_yaml);
  ...
  private:
    ...
    std::shared_ptr<ConstructVectorField> contruct_vector_field_ptr_;
    ...
    Buffer<std::shared_ptr<ConstructVectorField::VectorFieldParam>> vector_field_buffer_;
