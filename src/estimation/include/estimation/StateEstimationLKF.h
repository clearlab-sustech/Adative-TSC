...
namespace clear {
class StateEstimationLKF : public Node {
public:
  StateEstimationLKF(std::string config_yaml);
...
private:
  ...
  rclcpp::Publisher<trans::msg::EstimatedStates>::SharedPtr res_publisher_;
