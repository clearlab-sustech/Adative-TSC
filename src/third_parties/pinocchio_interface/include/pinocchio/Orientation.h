...
namespace clear {
matrix3_t
getJacobiFromOmegaToRPY(const vector3_t &rpy); 

matrix3_t
getJacobiFromRPYToOmega(const vector3_t &rpy); 

matrix3_t
getJacobiDotFromRPYToOmega(const vector3_t &rpy, const vector3_t &rpy_dot); 
...
Eigen::Quaternion<scalar_t> toQuaternion(const vector3_t &rpy); // roll (x), pitch (Y), yaw (z)
