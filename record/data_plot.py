...
class DataPlot:
    ...
    def base_acc(self):
        ...
        ax1_1.plot(time+0.015, data2[:n, 0], lw='1', label="atsc")
        plt.autoscale(enable='true', axis='y')
        plt.legend()
        plt.grid()
        ...
        ax1_1.plot(time+0.015, data2[:n, 1], lw='1', label="atsc")
        plt.autoscale(enable='true', axis='y')
        plt.legend()
        plt.grid()
        ...
        ax1_1.plot(time+0.015, data2[:n, 2], lw='1', label="atsc")
        plt.autoscale(enable='true', axis='y')
        plt.legend()
        plt.grid()
        ...
        ax1_1.plot(time+0.015, data2[:n, 3], lw='1', label="atsc")
        plt.autoscale(enable='true', axis='y')
        plt.legend()
        plt.grid()
        ...
        ax1_1.plot(time+0.015, data2[:n, 4], lw='1', label="atsc")
        plt.autoscale(enable='true', axis='y')
        plt.legend()
        plt.grid()
        ...
        ax1_1.plot(time+0.015, data2[:n, 5], lw='1', label="atsc")
        plt.autoscale(enable='true', axis='y')
        plt.legend()
        plt.grid()
